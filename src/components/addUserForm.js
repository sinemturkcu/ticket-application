...
function setUser() {
  setUserDetails({
    username: document.getElementById("floating_username").value,
    ...
    phoneNumber: document.getElementById("floating_phone").value,
    role: document.getElementById("floating_role").value,
